...
static request waitForGroup()
{
    ...
    // TODO 
    // DOWN receptionistReq -- bloqueia até os grupos fazerem um pedido
    ...
    // TODO receptionistRequestPossible -- desbloqueia a possibilidade de fazer request ao receptionist
...
static void provideTableOrWaitingRoom (int n)
{
    ...
    if (table_id != -1)
    {
        ...
        // Up waitForTable[n] -- Sinalizar grupos que têm mesa atribuída
...
static void receivePayment (int n)
{
    ...
    // TODO     
    // Up tableDone[NUMTABLES] -- desbloqueia grupos à espera do fim do pagamento
