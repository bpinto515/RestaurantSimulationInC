...
static request waitForClientOrChef()
{
    ...
    // TODO 
    // DOWN waiterRequest -- bloqueia até chef ou grupos dizerem que podem fazer o request
    ...
    // TODO waiterRequestPossible -- desbloqueia a possibilidade de fazer request ao waiter
...
static void informChef (int n)
{
    ...
    // TODO 
    // UP do requestReceived [NUMTABLES] -- informa o grupo que o request foi recebido
    ...
    // UP do waitOrder -- leva a informação ao chef
    ...
    // DOWN do orderReceived -- Espera que o chefe diga que recebeu 
...
static void takeFoodToTable (int n)
{
    ...
    // Up do foodArrived [NUMTABLES] para informar o grupo que a comida chegou
